(()=>{var Z=Object.defineProperty;var P=(e,t)=>()=>(e&&(t=e(e=0)),t);var Q=(e,t)=>{for(var o in t)Z(e,o,{get:t[o],enumerable:!0})};async function f(e,t={}){return new Promise((o,n)=>{chrome.runtime.sendMessage({type:e,...t},r=>{chrome.runtime.lastError?n(new Error(chrome.runtime.lastError.message)):r&&r.success?o(r.data):n(new Error(r?.error||"Unknown error"))})})}function N(e,t){return`damkoi:${e}:${t}`}function F(e){try{let t=localStorage.getItem(e);if(!t)return null;let{data:o,timestamp:n}=JSON.parse(t);return Date.now()-n>oe?(localStorage.removeItem(e),null):o}catch(t){return console.warn("[DamKoi Cache] Failed to read cache:",t),null}}function O(e,t){try{localStorage.setItem(e,JSON.stringify({data:t,timestamp:Date.now()}))}catch(o){console.warn("[DamKoi Cache] Failed to save cache:",o)}}function re(){try{let e=localStorage.getItem(M);return e?JSON.parse(e):[]}catch(e){return console.warn("[DamKoi] Failed to read recent verdicts:",e),[]}}function H(e){try{let o=re().filter(r=>r.product_id!==e.product_id),n=[e,...o].slice(0,ne);localStorage.setItem(M,JSON.stringify(n))}catch(t){console.warn("[DamKoi] Failed to add recent verdict:",t)}}function K(e,t){try{let o=JSON.parse(localStorage.getItem(R)||"{}");o[e]={duration:t,timestamp:Date.now()},localStorage.setItem(R,JSON.stringify(o))}catch(o){console.warn("[DamKoi Perf] Failed to record metric:",o)}}function U(e){return e>=8?"#10b981":e>=6?"#f59e0b":e>=4?"#ef4444":"#dc2626"}function y(e){return e>=8?"score-green":e>=6?"score-amber":"score-red"}function u(e){return e?`\u09F3${(e/100).toLocaleString("en-BD")}`:"\u2014"}function z(e,t,o,n=[te]){return{product_id:e,target_price:parseInt(t)*100,email:o.trim(),notify_via:n}}function E(e,t,o){if(!e)return;let n=t==="success",r=t==="info";e.textContent=o,e.classList.remove("dk-status-success","dk-status-error","dk-status-info"),n?e.classList.add("dk-status-success"):r?e.classList.add("dk-status-info"):e.classList.add("dk-status-error")}function V(e){return e&&/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.trim())}function G(e){let t=parseInt(e);return!isNaN(t)&&t>0}var C,b,ee,te,oe,ne,M,R,_=P(()=>{C="https://damkoi.xynly.com",b="https://damkoi.xynly.com";ee={EMAIL:"email",SMS:"sms",PUSH:"push"},te=ee.EMAIL,oe=60*60*1e3,ne=10,M="damkoi:recent-verdicts";R="damkoi:perf-metrics"});var $={};Q($,{default:()=>he});var fe,he,D=P(()=>{_();fe={renderDealGauge(e,t){let o=document.getElementById(t);if(!o)return;let r=Math.min(Math.max(e,0),10)/10,i=U(e),a=Math.PI*40,s=a*(1-r);o.innerHTML=`
